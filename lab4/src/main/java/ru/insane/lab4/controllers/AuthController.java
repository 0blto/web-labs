...
public class AuthController {
    ...
    private boolean validateCredentials(AuthRequest authRequest) {
        return authRequest.getUsername() != null && authRequest.getPassword() != null &&
                authRequest.getUsername().matches("[a-zA-Z0-9]{4,16}") &&
                authRequest.getPassword().matches("[!-~]{8,20}");
    }
