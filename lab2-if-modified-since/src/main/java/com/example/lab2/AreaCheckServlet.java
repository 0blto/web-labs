...
import com.example.lab2.util.Dot;
...
public class AreaCheckServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println(this.getServletContext().getAttribute(Variables.DOTS_NAME).toString());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (sentData == null) {
            ...
            if (this.validateData(sentData)) {
                Result result = new Result(LocalDateTime.now(), (int)(System.nanoTime() - time),
                        sentData.getX(), sentData.getY(), sentData.getR(),
                        this.isHit(sentData.getX(), sentData.getY(), sentData.getR()) ? "Попадание" : "Промах", sentData.isByClick());
                ...
                this.getServletContext().setAttribute(Variables.LAST_MODIFIED, ZonedDateTime.now());
